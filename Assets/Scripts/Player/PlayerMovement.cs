...
public class PlayerMovement : MonoBehaviour
{
    ...
    public float wallrunForce = 400f;
    ...
    {
        if (Input.GetKey(KeyCode.W) && (isWallRight || isWallLeft)) Wallrun();
    }
    private void Wallrun()
    {
        ...
        if (rb.velocity.magnitude <= maxWallSpeed) rb.AddForce(orientation.forward * maxWallSpeed * Time.deltaTime);
